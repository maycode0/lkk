...
We adopt the pretrained models provided including BERT, RoBERTa, CNN, LSTM. These data and models are adopted from  [HLBB](https://arxiv.org/abs/2012.14956) or [TextAttack](https://textattack.readthedocs.io/en/latest/).
...
RoBERTa classification target:

```bash
python LimeAttack_classification.py --dataset_path data/mr --target_model roberta --model_path /path/to/roberta-classifier --max_seq_length 256
```
